...
pub enum Action {
    ...
    StateStartRunArgsEditor,
    StateRunArgsNextField,
    StateRunArgsPreviousField,
    StateRunArgsEditCurrent,
    StateRunArgsConfirm,
    StateRunArgsCancel,
    StateRunArgsEditInput(char),
    StateRunArgsEditBackspace,
    StateRunArgsEditDelete,
    StateRunArgsCommitEdit,
    StateRunArgsCancelEdit,
    OutputDirFetched(Result<Vec<PathBuf>, String>),
